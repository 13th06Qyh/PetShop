...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin.edit.blog', ['id' => $blogs->maBlog])}}">Sửa bài
                    viết</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form class="row" action="{{route('admin.edit.updateblog', ['id' => $blogs->maBlog])}}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group col-md-3">
                            <label class="control-label">Tiêu đề</label>
                            <input name="titleblog" class="form-control" type="text" value="{{$blogs->title}}" required>
                        </div>
                        <div class="form-group col-md-12">
                            ...
                            <div id="thumbbox">
                                @foreach ($blogs->ImageBlog as $image)
                                <img src="{{ asset($image->image) }}" alt="Thumb image" id="thumbimage"
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="content" class="form-control" rows="5" id="content"
                                required>{{ old('content', $blogs->noidung) }}</textarea>
                            <script>
                        ...
                        <!-- <div class="form-group col-md-3 ">
                            ...
                            <select name="animal_id" class="form-control" id="exampleSelect4" required>
                                <option value="{{$blogs->maAnimal}}" selected>{{$blogs->animal->animalname}}</option>
                        ...
                        <div class="form-group">
                            <button id="addblog" class="btn btn-save" type="submit">Cập nhật</button>
