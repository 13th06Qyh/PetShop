...
<!-- Tên trang -->
@section('title')
<title>Review một số loài chim</title>
@endsection
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('blogchim.view') }}">Blog Chim</a></li>
            </ol>
            <h2>Một Số Kiến Thức Về Những Chú Chim </h2>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item search-form">
                            <form action="{{ route('searchBCI.view') }}" method="GET">
