...
<!-- Tên trang -->
@section('title')
<title>Shop vật dụng chó</title>
@endsection
@section('find')
<form action="{{ route('searchDCC.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm vật dụng của cún tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopchodc.view') }}">Shop Cún Vật Dụng</a></li>
            </ol>
            <center>
                <h2>Vật Dụng Của Chó Cưng</h2>
            </center>
