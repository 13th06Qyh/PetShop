...
@endsection
@section('find')
<form action="{{ route('searchCA.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm sản phẩm của cá tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopca.view') }}">Shop Cá</a></li>
            </ol>
            <center>
                <h2>Sản Phẩm Của Cá Cảnh</h2>
            </center>
