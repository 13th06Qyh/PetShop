...
<!-- Tên trang -->
@section('title')
<title>Review một số loài chuột</title>
@endsection
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('blogchuot.view') }}">Blog Chuột</a></li>
            </ol>
            <h2>Một Số Kiến Thức Về Những Chú Chuột </h2>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item search-form">
                            <form action="{{ route('searchBCU.view') }}" method="GET">
