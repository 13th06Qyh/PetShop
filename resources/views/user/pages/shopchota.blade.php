...
<!-- Tên trang -->
@section('title')
<title>Shop thức ăn chó</title>
@endsection
@section('find')
<form action="{{ route('searchTAC.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm thức ăn của cún tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopchota.view') }}">Shop Cún Thức Ăn</a></li>
            </ol>
            <center>
                <h2>Thức Ăn Của Chó Cưng</h2>
            </center>
    ...
    <section class="property-grid grid">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        <li data-filter=".filter-app" data-tag="Quần Áo">Dạng khô</li>
                        <li data-filter=".filter-card">Dạng nước</li>
                        <li data-filter=".filter-web">Thuốc</li>
                    </ul>
                </div>
            </div>
            @if(count($sanphams) > 0)
            <div class="row portfolio-container">
                ...
                @if ($sanpham->Tag->tagname == 'Dạng khô')
                ...
                @elseif ($sanpham->Tag->tagname == 'Dạng nước')
