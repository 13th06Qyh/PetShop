...
<!-- Tên trang -->
@section('title')
<title>Shop quần áo mèo</title>
@endsection
@section('find')
<form action="{{ route('searchQAM.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm quần áo của mèo tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopmeoqa.view') }}">Shop Mèo Quần Áo</a></li>
            </ol>
            <center>
                <h2>Quần Áo Của Mèo Cưng</h2>
            </center>
