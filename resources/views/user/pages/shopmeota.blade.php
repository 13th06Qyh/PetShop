...
<!-- Tên trang -->
@section('title')
<title>Shop thức ăn mèo</title>
@endsection
@section('find')
<form action="{{ route('searchTAM.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm thức ăn của mèo tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopmeota.view') }}">Shop Mèo Thức Ăn</a></li>
            </ol>
            <center>
                <h2>Thức Ăn Của Mèo Cưng</h2>
            </center>
