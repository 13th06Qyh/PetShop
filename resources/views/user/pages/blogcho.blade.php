...
<!-- Tên trang -->
@section('title')
<title>Review một số loài cún</title>
@endsection
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('blogcho.view') }}">Blog Cún</a></li>
            </ol>
            <h2>Một Số Kiến Thức Về Những Chú Chó </h2>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item search-form">
                            <form action="{{ route('searchBC.view') }}" method="GET">
