...
<!-- Tên trang -->
@section('title')
<title>Shop chim</title>
@endsection
@section('find')
<form action="{{ route('searchCI.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm sản phẩm của chim tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopchim.view') }}">Shop Chim</a></li>
            </ol>
            <center>
                <h2>Sản Phẩm Của Chim Cảnh</h2>
            </center>
