...
<!-- Tên trang -->
@section('title')
<title>Review một số loài mèo</title>
@endsection
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('blogmeo.view') }}">Blog Mèo</a></li>
            </ol>
            <h2>Một Số Kiến Thức Về Những Chú Mèo </h2>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item search-form">
                            <form action="{{ route('searchBM.view') }}" method="GET">
