...
<!-- Tên trang -->
@section('title')
<title>Shop vật dụng mèo</title>
@endsection
@section('find')
<form action="{{ route('searchDCM.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm vật dụng của mèo tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopmeodc.view') }}">Shop Mèo Vật Dụng</a></li>
            </ol>
            <center>
                <h2>Vật Dụng Của Mèo Cưng</h2>
            </center>
    ...
    <section class="property-grid grid">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        <li data-filter=".filter-app" data-tag="Quần Áo">Đồ chơi</li>
                        <li data-filter=".filter-card">Lồng</li>
                        <li data-filter=".filter-web">Linh tinh</li>
                    </ul>
                </div>
            </div>
            @if(count($sanphams) > 0)
            <div class="row portfolio-container">
                ...
                @if ($sanpham->Tag->tagname == 'Đồ chơi')
                ...
                @elseif ($sanpham->Tag->tagname == 'Lồng')
