...
<!-- Tên trang -->
@section('title')
<title>Shop chuột</title>
@endsection
@section('find')
<form action="{{ route('searchCU.view') }}" method="GET">
    <input placeholder="&nbsp; Tìm kiếm sản phẩm của chuột tại đây" type="search" class="input" name="search">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li><a href="{{ route('shopchuot.view') }}">Shop Chuột</a></li>
            </ol>
            <center>
                <h2>Sản phẩm Của Chuột Cưng</h2>
            </center>
